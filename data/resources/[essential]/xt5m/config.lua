...
Config.FirstSpawnCoords = {x = 244.58, y = -765.44, z = 30.8, heading = 169.52} -- first spawn coordinates
...
Config.MaxWeight            = 2400000000   -- the max inventory weight without backpack(this is in grams, not kg!)
