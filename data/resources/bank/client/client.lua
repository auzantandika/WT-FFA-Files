...
local bankMenu	= true
local banks = {
	{name="Bank", id=108, x=256.37, y=-784.16, z=29.5},
	{name="Bank", id=108, x=-1212.980, y=-330.841, z=37.787},
	{name="Bank", id=108, x=-2962.582, y=482.627, z=15.703},
	{name="Bank", id=108, x=-112.202, y=6469.295, z=31.626},
	{name="Bank", id=108, x=441.17, y=-987.13, z=30.69},
...
local atms = {
	{name="ATM", id=277, x=-441.2, y=-987.11, z=30.69},
...
if bankMenu then
	...
	if nearBank() or nearATM() then
			DisplayHelpText("Tekan ~INPUT_PICKUP~ Untuk Akses Bank ~b~")
