...
AddEventHandler('esx_holdup:tooFar', function()
	...
	exports['mythic_notify']:DoCustomHudText('error', _U('robbery_cancelled'), 5000)
end)
...
AddEventHandler('esx_holdup:robberyComplete', function(award)
	...
	exports['mythic_notify']:DoHudText('inform', _U('robbery_complete', award))
end)
					...
					if distance < 0.5 then
						...
						if IsControlJustReleased(0, 38) then
							if IsPedArmed(PlayerPedId(), 4) then
								...
								exports['mythic_notify']:DoCustomHudText('inform', _U('no_threat'), 5000)
							end
						end
					end
				end
