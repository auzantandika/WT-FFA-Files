...
ESX.RegisterServerCallback('esx_clotheshop:buyClothes', function(source, cb)
	...
	if xPlayer.getMoney() >= Config.Priceclothes then
		xPlayer.removeMoney(Config.Priceclothes)
		TriggerClientEvent('esx:showNotification', source, _U('you_paid', Config.Priceclothes))
		cb(true)
	else
		cb(false)
	end
