Locales['en'] = {
  ...
  -- Death
  ['respawn_available_in'] = 'Waktu respawn tersisa ~b~%s menit %s detik~s~',
  ...
  ['respawn_bleedout_fine'] = 'Tahan [~b~E~s~] untuk respawn ~g~$7K~s~',
  ['respawn_bleedout_fine_msg'] = 'you paid ~r~$%s~s~ to respawn.',
  ['distress_send'] = 'Tekan [~b~G~s~] untuk mengirim signal',
  ['distress_sent'] = 'Signal sudah di kirim kepada dinas kesehatan, harap bersabar!',
  ['distress_message'] = 'Lokasi Korban!',
