...
function StartDistressSignal()
	Citizen.CreateThread(function()
		...
		while timer > 0 and IsDead do
			...
			EndTextCommandDisplayText(0.43, 0.84)
...
function StartDeathTimer()
	...
	Citizen.CreateThread(function()
		...
		while bleedoutTimer > 0 and IsDead do
			...
			if IsControlPressed(0, Keys['E']) and timeHeld > 60 and bleedoutTimer < 360 then
	...
	Citizen.CreateThread(function()
		...
		while bleedoutTimer > 0 and IsDead do
			...
			text = "Tekan [~b~H~s~] jika tidak terlihat ~b~|~s~ Tahan [~b~E~s~] untuk respawn"

			-- text = "Tekan [~b~H~s~] jika tidak terlihat ~b~|~s~"
