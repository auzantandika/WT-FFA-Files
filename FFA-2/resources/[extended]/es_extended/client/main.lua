...
AddEventHandler('esx:spawnVehicle', function(vehicleName)
	...
	if IsModelInCdimage(model) then
		...
		-- TriggerEvent('chat:addMessage', { template = '<div class="chat-message system"><b>{0}:</b> {1}</div>', {args = {'^1SYSTEM', 'Invalid Vehicle Model.'}} ))
		TriggerEvent('chat:addMessage', {
			template = '<div class="chat-message server"><b>SYSTEM:</b> Invalid Vehicle Model.</div>',
			args = { }
		  })
