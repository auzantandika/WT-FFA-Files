...
set /P inp=(Insert Here Randoom Trigger event (Example: 0nixAC)
goto :0nixAC
...
replace.py "gcPhone:tchat_channel" "gcPhone:tchat_channel%inp%"
...
replace.py "esx_billing:sendBill" "esx_bi%inp%lling:sendBill"
