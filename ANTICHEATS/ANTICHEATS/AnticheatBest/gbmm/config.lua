...
Config.KickMessage = 'Really? Good bye!!'

Config.key = 121 --Key to open administrative tool - Default "Insert"

Config.AntiResourceStartCheck = true --Detects if a player tries to start a script
Config.AntiResourceStopCheck = true --Detects if a player tries to stop a script
Config.AntiBlips = false --Detects if a player activates the blips of all the players
Config.AntiOBJSpawn = true --Removes walls among other things generated by cheaters
Config.AntiCheat = true 
Config.AntiGodmode = true --Updated in test!--
Config.AntiSpectate = true
Config.PlayerProtection = true 
Config.AntiSpeedHack = false --Updated in test!--

---------------Blacklisted Commands----------------
Config.AntiCarDetroy = true --IN TEST!--
Config.AntiBlacklistedCmds = true 
Config.AntiInjections = true 
Config.AntiExecutor = true 
Config.AntiCheatEngine = true  --UPDATED IN TEST!--
Config.AntiHash = true  
Config.AntiAimbot = true  --IN TEST
Config.AntiVpnConnections = true  
Config.MenuExternal = true  --IN TEST
Config.ChatSpam = true  --IN TEST

--LITTLEAC BYPASS--
Config.Bypass = {"LittleACGBadmin","LittleACGBmod","LittleACGBpolice"} --GODMODE,BLIPS,BLACKLISTEDCMDS,SPEEDHACK,TRIGGERS...

Config.OpenMenuAllowed = {"LittleACGBadmin"}
Config.SpectateAllowed = {"LittleACGBadmin","LittleACGBmod"}
Config.ClearAreaAllowed = {"LittleACGBadmin"}
Config.BlipsAllowed = {"LittleACGBadmin", "LittleACGBmod", "LittleACGBpolice"} --PERMISSIONS BLIPS
